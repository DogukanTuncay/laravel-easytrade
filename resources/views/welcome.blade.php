...
<nav class="navbar navbar-expand-lg navbar-dark menu shadow fixed-top">
    <div class="container">
      <a class="navbar-brand" href="">
        <img src="{{asset('resources/images/autonomous.png')}}" class="img-fluid" width="100px" alt="logo image">
      </a>
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        <ul class="navbar-nav">
          {{-- <li class="nav-item"><a class="nav-link active" aria-current="page" href="index.html">Dashboard</a></li>
        ...
        @if (Route::has('login'))
            @auth
                <li href="{{ url('/dashboard') }}" class="nav-item"><a class="nav-link" href="{{route('dashboard')}}"> Dashboard</a></li>
            @else
                <li href="{{ url('/dashboard') }}" class="nav-item"><a class="nav-link" href="{{route('login')}}">Log in</a></li>

                @if (Route::has('register'))
                <li href="{{ url('/dashboard') }}" class="nav-item"><a class="nav-link" href="{{route('register')}}">Register</a></li>
  ...
  <div class="container">
    <div class="row align-items-center text-white">
      ...
      <div class="col-md-6 intros text-start">
        ...
        <a href="{{route('login')}}">
            <button type="button" onclick="" class="rounded-pill btn-rounded">Quick Start
      ...
      <div class="col-md-6 intros text-end">
        <div class="video-box">
          <img src="{{asset('resources/images/autonomous.png')}}" alt="video illutration" class="img-fluid">
          <a href="https://www.youtube.com/watch?v=mgwVqtMIo4Y" class="glightbox position-absolute top-50 start-50 translate-middle">
            <span>
  ...
  <i class="fas fa-chevron-up"></i>
    ...
    <script type="text/javascript">
      const lightbox = GLightbox({
        ...
        'href': 'https://www.youtube.com/watch?v=mgwVqtMIo4Y',
        'type': 'video',
